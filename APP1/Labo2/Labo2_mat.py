...
if mode == 'test':
    ...
    x_train = np.genfromtxt('Labo2/train.csv', delimiter=',')[:,slice(0,2)]
    target_train = np.expand_dims(np.genfromtxt('Labo2/train.csv', delimiter=',')[:,2], axis=1)
    x_val = np.genfromtxt('Labo2/val.csv', delimiter=',')[:,slice(0,2)]
    target_val = np.expand_dims(np.genfromtxt('Labo2/val.csv', delimiter=',')[:,2], axis=1)
